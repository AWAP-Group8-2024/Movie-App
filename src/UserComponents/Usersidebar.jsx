...
import { IoLogOutOutline, IoPersonCircleOutline, IoPeopleCircle, IoNavigate } from "react-icons/io5";
					...
					<Sidebar>
						<Sidebar.Nav>
							<Button
								...
								name="profile"
								className="mb-2"><IoNavigate /> Profile
							</Button>
							<Button
								as={Link}
								to="/groups/user"
							...
							<Button
								...
								name="Logout"
								clasName="mb2"><IoLogOutOutline /> Logout
							</Button>
						</Sidebar.Nav>
					</Sidebar>
				</div>
